...
async function main() {
  ...
  const sourcePath = path.resolve(process.argv[2] || path.join(repositoryRoot, 'productfinder.json'))
  ...
  process.stdout.write(
    `Created partial release ${manifest.releaseId}: ${report.productCount} products, ${report.chunkCount} chunks.\n`,
  )
}
